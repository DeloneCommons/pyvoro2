...
| [v0.8.0 release notes](https://delonecommons.github.io/pyvoro2/project/release-notes-v0.8/) | Removals, fixes, maintenance, documentation, and the qualified distribution matrix. |
