...
Development through v0.9.0 covers functional/API stabilization followed by
pre-release whole-code comprehension and audit, remediation explicitly accepted
for pre-release work if any, and the documentation overhaul. Released v0.9.x is
the downstream-readiness soak; 1.0 stabilizes the existing core, prescribed cell
measures begin in v1.1, and mixed separator-plus-measure problems begin in v1.2.
