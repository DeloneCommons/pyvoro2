...
- the required branches converge at #15, followed by #20, #16, and release
  qualification in #18.

Issue #17 branches conditionally from #14 and does not block that required
sequence. The dependency table below is authoritative where several branches
converge.
...
| [#15](https://github.com/DeloneCommons/pyvoro2/issues/15) | Add paper-style regressions and a chemvoro-shaped integration workflow. | #8, #10, #12, #13, #14 | Required |
...
| [#17](https://github.com/DeloneCommons/pyvoro2/issues/17) | Benchmark dense and optional sparse quadratic separator solving. | #14 | Conditional; non-blocking |
| [#18](https://github.com/DeloneCommons/pyvoro2/issues/18) | Qualify and release v0.7.0. | All required milestone work; #17 may conclude with a documented deferral | Release |
...
7. After downstream validation and notebook API migration, execute and publish
   notebook outputs through WP-07A.
8. Finalize lifecycle and migration documentation after WP-07A.
9. Run sparse benchmarking independently after the operator view exists.
