...
- forward work proceeds through #7 and #8, while #9 starts from #6 and
  coordinates with #8; #8 and #9 converge at #10;
...
| [#8](https://github.com/DeloneCommons/pyvoro2/issues/8) | Add direct weight-first forward computation in 2D and 3D. | #7 | Required |
