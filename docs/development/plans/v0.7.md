...
**Status:** The result-layering portion is implemented under
[#13](https://github.com/DeloneCommons/pyvoro2/issues/13). WP-06 remains open:
public graph, incidence, right-hand-side, and quadratic-operator access belongs
to [#14](https://github.com/DeloneCommons/pyvoro2/issues/14).
