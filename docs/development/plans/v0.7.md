...
**Status:** Implemented in the current tree by
[#16](https://github.com/DeloneCommons/pyvoro2/issues/16); clean source-build,
strict-docs, and full release-environment verification remain pending.
...
- record release-candidate evidence in the
...
- [x] The API lifecycle inventory is complete and approved.
...
sparse-path outcome, migration horizon, and deferred follow-up issues.
