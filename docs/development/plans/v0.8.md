...
- **Activation:** after v0.7.0 release qualification
...
cycle. It does not authorize implementation before v0.7.0 is released and a
v0.8 milestone and issue set are approved.
