...
**Current implementation status (2026-08-07):** R3-A is merged. The R3-B
implementation patch for issue #39 applies package-wide strict input adoption,
canonical domain ownership, owned retained arrays, early handedness rejection,
and safe remap conversion. R3 remains open pending independent integrated R3
review and the complete regression gate.
